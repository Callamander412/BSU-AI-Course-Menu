      ...
      content: (
        <>
          ...
          <div className="tutorial-images-grid">
            <div className="tutorial-image-container">
              <img src="https://customer-assets.emergentagent.com/job_bsu-ai-projects/artifacts/mqtz2wxu_image.png" alt="Meshy 3D model preview" className="tutorial-image" />
              <p className="image-caption">3D model generated in Meshy - Topology: 354,028 Triangles, 197,175 Vertices</p>
            </div>
            <div className="tutorial-image-container">
              <img src="https://customer-assets.emergentagent.com/job_bsu-ai-projects/artifacts/7r5emov4_image.png" alt="Meshy side view preview" className="tutorial-image" />
            </div>
            <div className="tutorial-image-container">
              <img src="https://customer-assets.emergentagent.com/job_bsu-ai-projects/artifacts/8n4oepmn_image.png" alt="3D model head close-up" className="tutorial-image" />
            </div>
          </div>
          <div className="tip-box">
            <AlertCircle size={20} />
    ...
    <div className="bobblehead-tutorial-page">
      ...
      <section className="credits-section">
        ...
        <ul className="credits-list">
          <li><a href="https://www.meshy.ai/" target="_blank" rel="noopener noreferrer">Meshy <ExternalLink size={14} className="inline-icon" /></a></li>
          <li><a href="https://sketchfab.com/" target="_blank" rel="noopener noreferrer">Sketchfab <ExternalLink size={14} className="inline-icon" /></a></li>
          <li><a href="https://news.harvard.edu/gazette/story/2023/08/is-art-generated-by-artificial-intelligence-real-art/" target="_blank" rel="noopener noreferrer">"Is Art Generated by AI Real Art?" – Harvard Gazette <ExternalLink size={14} className="inline-icon" /></a></li>
          <li><a href="https://www.forbes.com/sites/lanceeliot/2022/07/02/ai-ethics-starkly-questioning-human-voice-cloning-such-as-those-of-your-deceased-relatives-intended-for-use-in-ai-autonomous-systems/" target="_blank" rel="noopener noreferrer">AI Ethics: Voice Cloning – Forbes <ExternalLink size={14} className="inline-icon" /></a></li>
          <li><a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener noreferrer">Creative Commons License (CC BY 4.0) <ExternalLink size={14} className="inline-icon" /></a></li>
          <li><a href="https://bambulab.com/en/software/bambu-studio" target="_blank" rel="noopener noreferrer">Bambu Studio <ExternalLink size={14} className="inline-icon" /></a></li>
        </ul>
      </section>
